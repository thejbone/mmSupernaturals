...
public class SNCommandAdmin extends SNCommand {
    ...
    static {
        adminHelpMessages.add("*** " + ChatColor.WHITE + "Supernatural 管理者指令"
                + ChatColor.RED + " ***");
        adminHelpMessages.add("/sn cure <玩家名稱> " + ChatColor.WHITE
                + "- 治療自己或玩家.");
        adminHelpMessages.add("/sn convert <玩家名稱> [超自然生物] " + ChatColor.WHITE
                + "- 將自己或玩家轉換為任意的超自然生物.");
        adminHelpMessages.add("/sn reset <玩家名稱>" + ChatColor.WHITE
                + "- 重置自己或玩家的能量.");
        adminHelpMessages.add("/sn power <玩家名稱> [Power] " + ChatColor.WHITE
                + "- 給自己或玩家能量.");
        adminHelpMessages.add("/sn rmtarget <玩家名稱> " + ChatColor.WHITE
                + "- 將玩家從魔女獵人的獵殺名單移除.");
        adminHelpMessages.add("/sn save " + ChatColor.WHITE + "- 儲存資料到硬碟.");
        adminHelpMessages.add("/sn reload " + ChatColor.WHITE + "- 從硬碟讀取資料.");
