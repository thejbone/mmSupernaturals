...
public class SNCommandClasses extends SNCommand {
    ...
    static {
        classMessages.add("*** " + ChatColor.WHITE + "Supernatural 種族/職業"
                + ChatColor.RED + "***");
        classMessages.add("人類(Human): " + ChatColor.WHITE + "- 不起眼的平凡人類.");
        classMessages.add("牧師(Priest): " + ChatColor.WHITE
                + "- 一個擁有不凡力量來對抗邪惡生物的人類.");
        classMessages.add("吸血鬼(Vampire): " + ChatColor.WHITE + "- 它們並不會冒出火花!");
        classMessages
                .add("食屍鬼(Ghoul): " + ChatColor.WHITE + "- 行動遲緩並且非常不容易死亡.");
        classMessages.add("狼人(Werewolf): " + ChatColor.WHITE + "- 在夜晚獲得強大的力量.");
        classMessages.add("女巫獵人(WitchHunter): " + ChatColor.WHITE
                + "- 弓箭和潛行的專家.");
        classMessages.add("惡魔(Demon): " + ChatColor.WHITE + "- 支配邪惡的生物與火焰.");
        classMessages.add("天使(Angel): " + ChatColor.WHITE + "一個靈魂無法被束縛的人類.");
